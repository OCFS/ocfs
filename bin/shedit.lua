...
-- color scheme
local bgColor = 0x303030
local lineColor = 0x303030
local textColor = 0xF8F8F2
local keywordColor = 0xfdc35f
local commentColor = 0x26c9ff
local stringColor = 0xff95f2
local valueColor = 0xff95f2
local builtinColor = 0x26c9ff
